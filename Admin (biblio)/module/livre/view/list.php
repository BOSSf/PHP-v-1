...
<a class="btn btn-success" href="<?php echo $this->getLink('livre::edit',array(
										'id'=>$oLivre->getId()
									) 
							)?>">Edit</a>
			| 
<a class="btn btn-danger" href="<?php echo $this->getLink('livre::delete',array(
										'id'=>$oLivre->getId()
									) 
							)?>">Delete</a>
			| 
<a class="btn btn-default" href="<?php echo $this->getLink('livre::show',array(
										'id'=>$oLivre->getId()
									) 
							)?>">Show</a>
...
<p><a class="btn btn-primary" href="<?php echo $this->getLink('livre::new') ?>">New</a></p>
