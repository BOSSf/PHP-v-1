<?php
class model_admin extends abstract_model{
	
	protected $sClassRow='row_admin';
	
	protected $sTable='admin';
	protected $sConfig='pdoMysqlExple';
	
	protected $tId=array('id_admin');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE id_admin=?',$uId );
	}
	...
	public function getListAccount(){
       ...
       //on cree ici un tableau indexe par nom d'utilisateur et mot de pase
           $tLoginPassAccount[$oAccount->login_a][$oAccount->pass_a]=$oAccount;
       }
       }
...
class row_admin extends abstract_row{
	
	protected $sClassModel='model_admin';
