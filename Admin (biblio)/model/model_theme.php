<?php
class model_theme extends abstract_model{
	
	protected $sClassRow='row_theme';
	
	protected $sTable='theme';
	protected $sConfig='pdoMysqlExple';
	
	protected $tId=array('Id_theme');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE Id_theme=?',$uId );
	}
...
class row_theme extends abstract_row{
	
	protected $sClassModel='model_theme';
