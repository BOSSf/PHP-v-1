<?php
class model_editeur extends abstract_model{
	
	protected $sClassRow='row_editeur';
	
	protected $sTable='editeur';
	protected $sConfig='pdoMysqlExple';
	
	protected $tId=array('Id_Editeur');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE Id_Editeur=?',$uId );
	}
...
class row_editeur extends abstract_row{
	
	protected $sClassModel='model_editeur';
